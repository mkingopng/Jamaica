...
Copyright (C) Weicong Kong, 25/08/2021
"""

import pyodbc
import with_pyodbc
from with_pyodbc import create_engine
import sqlite3
import pandas as pd
import time


# 1. to specify an engine
engine = create_engine(
	'mssql+pyodbc://@0599Z0NDBRPSL01/Comrade?trusted_connection=yes&driver=ODBC+Driver+17+for+SQL+Server')
...
SELECT
	...
	ST03005 AS 'CITY',
	SUBSTRING(ST03001, 0, {num_chars}) AS 'PROVINCE'
...
# these two df should be the same
df2 = pd.read_csv('../data/test_query.csv')
