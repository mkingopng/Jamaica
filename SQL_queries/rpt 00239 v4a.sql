USE [IscalaAnalysis]
GO
/****** Object:  StoredProcedure [dbo].[SSRS_Rpt00239_sel_chem_v4a]    Script Date: 10/04/2021 14:58:34 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SSRS_Rpt00239_sel_chem_v4a] 
--DECLARE
...
SELECT @command = @command + 'AND SC01001 BETWEEN ''10-01-0000'' AND ''10-05-1025'' '
