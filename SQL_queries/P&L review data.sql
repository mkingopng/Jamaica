...
FROM ST030100 INNER JOIN SC010100 ON ST03017=SC01001
LEFT OUTER JOIN SL010100 ON SL01001=ST03001
LEFT OUTER JOIN GL030120 ON SUBSTRING(ST03011,7,2)=GL03002
