USE [IscalaAnalysis]
GO
/****** Object:  StoredProcedure [dbo].[SSRS_Rpt00093]    Script Date: 10/04/2021 14:35:51 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SSRS_Rpt00093]
...
--SELECT @ThisMonth =  rtrim(cast(datepart(yyyy,GETDATE()) as char))+ 'M' + substring(cast(cast(datepart(mm,GETDATE()) as INT)+100 as char),2,2) 	
 ...
 WHERE  "SC010100"."SC01038" IN (N'CHS','CHI','CHR') AND "SC030100"."SC03002"=N'05'        
        And left(ltrim(ST03011),2)<>'24'
