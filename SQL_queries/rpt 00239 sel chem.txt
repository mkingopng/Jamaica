USE [IscalaAnalysis]
GO
/****** Object:  StoredProcedure [dbo].[SSRS_Rpt00239_sel_chem]    Script Date: 10/04/2021 14:54:10 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SSRS_Rpt00239_sel_chem] 
...
SELECT a.*, b.SC23002 as Warehouse_Name 
FROM #workData239 a
